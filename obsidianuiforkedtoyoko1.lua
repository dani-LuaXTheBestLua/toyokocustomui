...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(11, 11, 14),
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        --// Resize Handle (curved corner grip like the image)
        if WindowInfo.Resizable then
            ...
            -- Outer curved piece (cream/beige like the image)
            local Grip = New("Frame", {
                AnchorPoint = Vector2.new(1, 1),
                BackgroundColor3 = Color3.fromRGB(220, 200, 140),
            ...
            -- Cut the top-left so it looks like a corner curve
            local Cut = New("Frame", {
                BackgroundColor3 = "BackgroundColor",
